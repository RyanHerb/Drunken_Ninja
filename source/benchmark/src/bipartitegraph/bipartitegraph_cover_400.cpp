...
BENCHMARK_P_F(BipartiteGraph400, getCover, 10, 100, ()) {
    graph->getCover();
}

BENCHMARK_P_F(BipartiteGraph400, getCoverGreedy, 10, 100, ()) {
    graph->getCoverGreedy();
}

BENCHMARK_P_F(BipartiteGraph400, getCoverDFS, 10, 100, ()) {
    graph->getCoverDFS();
}
