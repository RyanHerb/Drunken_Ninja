...
BENCHMARK_P_F(BipartiteGraph800, getCover, 10, 100, ()) {
    graph->getCover();
}

BENCHMARK_P_F(BipartiteGraph800, getCoverGreedy, 10, 100, ()) {
    graph->getCoverGreedy();
}

BENCHMARK_P_F(BipartiteGraph800, getCoverDFS, 10, 100, ()) {
    graph->getCoverDFS();
}
